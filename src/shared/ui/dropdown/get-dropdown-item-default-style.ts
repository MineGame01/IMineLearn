...
export const getDropdownItemDefaultStyles = ({
  ...
  return twMerge(
    ...
    `before:transition-colors before:duration-100 before:ease-in-out hover:before:bg-accent before:content-[' '] before:absolute before:left-0 before:top-0 before:w-full before:h-full before:opacity-10 before:rounded-default-radius`,
